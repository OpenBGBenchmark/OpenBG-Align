...
请先下载FastRCNN模型[faster_rcnn_from_caffe_attr.pkl](https://drive.google.com/file/d/1NxQumuFWULtnWRGo4p6LtQ1YB2mzdwCu/view?usp=sharing)放到Capture_open/bp_feature文件夹下，下载Capture模型[pytorch_model_8.bin]()放到Capture_open/Capture文件夹下。
